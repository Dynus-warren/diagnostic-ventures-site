...
Forms validate input and open a pre-addressed email to `brian@diagnosticventures.net`. This keeps the completed message intact and requires no third-party service or API key.
